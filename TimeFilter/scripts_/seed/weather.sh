...
# Initialize result CSV with the seed column.
  ...
  for pred_len in "${pred_lens[@]}"; do
    ...
    for add_loss in "${loss_modes[@]}"; do
      ...
      for seed in "${seeds[@]}"; do
        ...
        # Add seed to model_id for unique log files.
        ...
        # Run the model and save output to log_file.
        # Pass the random seed.
